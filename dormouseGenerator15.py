...
if __name__ == "__main__":
    ...
    print("4. CompVis/stable-diffusion-1.3 (Public)")
    print("5. Custom model (enter Hugging Face ID)")
    print("6. Load local model (enter folder path)")
    ...
    if choice == "6":
        ...
        model_map = {
            ...
            "4": "CompVis/stable-diffusion-1.3"
        }
